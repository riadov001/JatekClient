...
// expo-notifications no longer supports push in Expo Go (SDK 53+). Calling
// setNotificationHandler / getPermissionsAsync there logs scary warnings or
// silently rejects — neither should ever crash the JS bundle ("écran bleu").
