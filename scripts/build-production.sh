...
echo ""
echo "[2/3] Build backend-dashboard (SPA → dist/public)…"
BASE_PATH=/ pnpm --filter @workspace/backend-dashboard run build

echo ""
echo "[3/3] Push DB schema to production database…"
